<x-layout>
    ...
    <div class="max-w-2xl mx-auto p-4 bg-slate-200 rounded-lg">
        <form action="{{ route('comments.update', $comment->id) }}" method="POST">
            ...
            <div class="mb-6">
                <button type="submit"
                    class="text-white shadow-lg shadow-indigo-500/40 bg-indigo-500 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update</button>
            </div>
        </form>
    </div>
</x-layout>
